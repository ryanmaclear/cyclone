...
export function createWebCycloneApi(): ICycloneApi {
    ...
    return {
        ...
        setSerialEmulatorEnabled: (enabled: boolean) => postJson<boolean>('/api/serial/emulator', { enabled }),
        ...
        sendManualGCode: (command: string) => postJson<IMarlinStatus>('/api/serial/manual', { command }),
